...
(defvar symbol-overlay-map
  (let ((map (make-sparse-keymap)))
    (define-key map (kbd "gh") #'symbol-overlay-map-help)
    (define-key map (kbd "p") #'symbol-overlay-jump-prev)
    (define-key map (kbd "n") #'symbol-overlay-jump-next)
    (define-key map (kbd "gf") #'symbol-overlay-jump-first)
    (define-key map (kbd "gl") #'symbol-overlay-jump-last)
    (define-key map (kbd "gw") #'symbol-overlay-save-symbol)
    (define-key map (kbd "gt") #'symbol-overlay-toggle-in-scope)
    (define-key map (kbd "ge") #'symbol-overlay-echo-mark)
    (define-key map (kbd "gd") #'symbol-overlay-jump-to-definition)
    (define-key map (kbd "gs") #'symbol-overlay-isearch-literally)
    (define-key map (kbd "gq") #'symbol-overlay-query-replace)
    (define-key map (kbd "gr") #'symbol-overlay-rename)
    map)
